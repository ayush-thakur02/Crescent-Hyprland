...
1. Install `Hyprland` from my [Installer Repo](https://github.com/ayush-thakur02/Hyprland-V3)
...
4. ```git clone https://github.com/ayush-thakur02/Hyprland-V3 && mv Hyprland-V3/* ~/.config/```
